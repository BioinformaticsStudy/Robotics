...
All the environments are registered in the `Basic_RL` extension. They start
...
import Basic_RL.tasks  # noqa: F401


def main():
    """Print all environments registered in `Basic_RL` extension."""
