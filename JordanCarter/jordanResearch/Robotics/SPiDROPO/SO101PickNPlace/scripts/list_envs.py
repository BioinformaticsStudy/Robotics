...
All the environments are registered in the `SO101PickNPlace` extension. They start
...
import SO101PickNPlace.tasks  # noqa: F401


def main():
    """Print all environments registered in `SO101PickNPlace` extension."""
