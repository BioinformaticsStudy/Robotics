...
from isaaclab_tasks.manager_based.manipulation.lift.lift_env_cfg import (
    LiftEnvCfg as BaseLiftEnvCfg
)

@configclass
class So101picknplaceEnvCfg(BaseLiftEnvCfg):
...
@configclass
class SO101LiftEnvCfg_PLAY(So101picknplaceEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        ...
        # Make object spawn closer to the robot
        ...
        print("OBJECT INIT:", self.scene.object.init_state.pos)
        print("ROBOT BASE:", self.scene.robot.root_state.pos)